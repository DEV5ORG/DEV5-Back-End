...
import com.dev5.backenddev5.Filter.JwtAuthenticationFilter;
        ...
        return http
                ...
                .exceptionHandling(
                        e->e.accessDeniedHandler(
                                        (request, response, accessDeniedException)->response.sendError(HttpStatus.FORBIDDEN.value(), "Access Denied")
                                )
